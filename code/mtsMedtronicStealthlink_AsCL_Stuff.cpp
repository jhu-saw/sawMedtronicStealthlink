...
//------------------------------------------------------------------------------
mtsMedtronicStealthlink_AsCL_IO_Watch::mtsMedtronicStealthlink_AsCL_IO_Watch(void) : Callback(0)
{
}


mtsMedtronicStealthlink_AsCL_IO_Watch::~mtsMedtronicStealthlink_AsCL_IO_Watch() {
    RemoveWatch();
}


int mtsMedtronicStealthlink_AsCL_IO_Watch::AddWatch(int sock, void * func, void * client_ptr)
{
    if (Callback)
...
void mtsMedtronicStealthlink_AsCL_IO_Watch::RemoveWatch(void)
{
    CMN_LOG_INIT_VERBOSE << "Stealthlink RemoveWatch called" << std::endl;
    Callback = 0;
}

void mtsMedtronicStealthlink_AsCL_IO_Watch::CheckWatch(void)
{
    if (Callback) {
        fd_set readfds;
        FD_ZERO( &readfds);
...
mtsMedtronicStealthlink_AsCL_Timeout::mtsMedtronicStealthlink_AsCL_Timeout(void) : Callback(0)
{
...
mtsMedtronicStealthlink_AsCL_Timeout::~mtsMedtronicStealthlink_AsCL_Timeout(void)
{
    RemoveTimeout();
...
int mtsMedtronicStealthlink_AsCL_Timeout::AddTimeout(int tmo_val, void * func, void * obj)
{
    if (Callback)
...
void mtsMedtronicStealthlink_AsCL_Timeout::RemoveTimeout(void)
{
...
void mtsMedtronicStealthlink_AsCL_Timeout::CheckTimeout(void)
{
...
//------------------------------------------------------------------------------
mtsMedtronicStealthlink_AsCL_Utils::mtsMedtronicStealthlink_AsCL_Utils(void) : curWatch(0), curTimeout(0)
{}


mtsMedtronicStealthlink_AsCL_Utils::~mtsMedtronicStealthlink_AsCL_Utils(void)
{}


AsCL_IO_Watch * mtsMedtronicStealthlink_AsCL_Utils::new_IO_Watch(void)
{
    if (curWatch)
        CMN_LOG_INIT_WARNING << "Stealthlink IO_Watch already allocated" << std::endl;

    curWatch = new mtsMedtronicStealthlink_AsCL_IO_Watch;
    return curWatch;
}


AsCL_Timeout * mtsMedtronicStealthlink_AsCL_Utils::new_Timeout(void)
{
    if (curTimeout)
        CMN_LOG_INIT_WARNING << "Stealthlink Timeout already allocated" << std::endl;

    curTimeout = new mtsMedtronicStealthlink_AsCL_Timeout;
    return curTimeout;
}

void mtsMedtronicStealthlink_AsCL_Utils::CheckCallbacks(void)
{
    if (curWatch)
        curWatch->CheckWatch();
    if (curTimeout)
